 ...
 */
/**
 * Build LexiconHelper Package
 *
 * Description: Build script for lexiconhelper package
 * @package lexiconhelper
 * @subpackage build
 */

/* Set package info be sure to set all of these */
define('PKG_NAME','LexiconHelper');
define('PKG_NAME_LOWER','lexiconhelper');
define('PKG_VERSION','1.0.0');
define('PKG_RELEASE','beta1');
define('PKG_CATEGORY','LexiconHelper');
